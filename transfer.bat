...
xcopy /s /y IO_list_automation\_Documentation.txt		_temp
xcopy /s /y IO_list_automation\_Change_log.txt		_temp
xcopy /s /y IO_list_automation\_plot.txt		_temp
xcopy /s /y Trend_plot.exe		_temp
